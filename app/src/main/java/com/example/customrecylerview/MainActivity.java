...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productArrayList.add(
                new Product("Dây cuốn", R.drawable.bluecable, 12000, 25, 4, 15));
        productArrayList.add(
                new Product("Dây cuốn", R.drawable.bluecable, 25000, 14, 5, 20));
        productArrayList.add(
                new Product("Dây cuốn", R.drawable.bluecable, 30000, 39, 3, 25));
